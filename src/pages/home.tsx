            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-lg text-black/80 dark:text-white/80 leading-relaxed">
                  ...
                  the department prepares students for successful careers. Welcome to the School of Chemical Engineering (SCHEME), VIT Vellore. Since the inception in 1994, the School of Chemical Engineering has gained its capacity incrementally, first to ensure that all academic programmes were offered professionally and to ensure that the graduates produced were of the highest quality and much sought by the industry and employers. The school has state-of-the-art infrastructural facilities for training the students. The students are trained by highly qualified, experienced and dedicated faculty. We stress the importance of the latest relevant software and ensure that the students are given practical hands-on training on the latest software used by industries such as ASPEN PLUS, HYSYS, MATLAB, and SOLID WORKS. 
                  For more information about the department, <a href="https://vit.ac.in/scheme" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:text-pink-800 underline">Go For SCHEME</a>.
                </p>
              </motion.div>
